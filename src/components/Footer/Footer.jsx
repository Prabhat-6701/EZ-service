...
const Footer = () => {
  return (
    <div className="w-[100vw] h-auto bg-slate-400 z-10 py-8 overflow-hidden">
      <div className="w-[93%] md:w-[95%] lg:w-[80%] xl:w-[80%] mx-auto flex flex-col justify-start gap-6">
        <div className="flex flex-col md:flex-col lg:flex-row xl:flex-row justify-start items-start md:items-start lg:items-center xl:items-center gap-2 md:gap-2 lg:gap-6 xl:gap-6 text-lg md:text-lg lg:text-2xl xl:text-2xl ">
          ...
          <div className="flex">
            <span className="flex justify-center items-center gap-4 md:gap-4 lg:gap-4 xl:gap-4 text-white cursor-pointer">
              <FaTiktok />
              <span className="mr-6">|</span>
            </span>
            <span className="flex justify-center items-center gap-4 md:gap-4 lg:gap-6 xl:gap-6 text-white cursor-pointer">
              <FaInstagram />
              <span className="mr-6">|</span>
            </span>
            <span className="flex justify-center items-center gap-4 md:gap-4 lg:gap-6 xl:gap-6 text-white cursor-pointer">
        ...
        <div className="flex flex-col md:flex-col lg:flex-row xl:flex-row gap-8 justify-between items-start w-full">
          <div className="flex flex-col justify-start items-center gap-2">
            <h1 className="w-full text-start text-xl text-black/50 font-semibold">
              Discover
            </h1>
          ...
          <div className="flex flex-col justify-start items-center gap-2">
            ...
            <div className="flex flex-col justify-start items-start  gap-1 text-white text-md font-bold">
              <p>
                Tackle your to-do list wherever you are with our <br /> mobile
                app.
              </p>
      ...
      <div className='w-full flex justify-center items-center text-black  font-bold px-4 md:px-4 lg:px-8 xl:px-8 mt-10 -mb-10'>
            <p className=' border-t-2 w-full text-center py-3 text-lg md:text-lg lg:text-2xl xl:text-2xl'>Made by Prabhat</p>
        </div>
    </div>
  );
};
